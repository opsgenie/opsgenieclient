 ...
 */
public class DisableNotificationRuleRequest extends BaseUserRequest<DisableNotificationRuleResponse, DisableNotificationRuleRequest> {
    private String id;
    ...
    public DisableNotificationRuleRequest withId(String id) {
        this.id = id;
        return this;
    }
}
