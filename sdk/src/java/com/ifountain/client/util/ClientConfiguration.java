...
import com.ifountain.client.http.DefaultRequestRetryHandler;
import com.ifountain.client.http.IRequestRetryHandler;
...
public class ClientConfiguration {
    ...
    private IRequestRetryHandler retryHandler = new DefaultRequestRetryHandler();
     ...
     */
    public IRequestRetryHandler getRetryHandler() {
        return retryHandler;
    }
     ...
     */
    public ClientConfiguration setRetryHandler(IRequestRetryHandler retryHandler) {
    ...
    public static String createUserAgentFromManifest(Class manifestFileClass){
        ...
        if(sdkProductName == null) sdkProductName = "ifountain-sdk-java";
