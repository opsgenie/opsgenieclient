...
public class HttpClient {
    ...
    public HttpResponse post(String uri, Map<String, Object> parameters) throws IOException {
    ...
    public HttpResponse post(String uri, String content) throws IOException {
        return post(uri, content, new HashMap<String, String>());
    }

    public HttpResponse post(String uri, byte[] content) throws IOException {
        return post(uri, content, new HashMap<String, String>());
    }

    public HttpResponse post(String uri, HttpEntity entity) throws IOException {
        return post(uri, entity, new HashMap<String, String>());
    }

    public HttpResponse post(String uri, String content, Map<String, String> headers) throws IOException {
    ...
    public HttpResponse post(String uri, byte[] content, Map<String, String> headers) throws IOException {
        HttpPost postMethod = new HttpPost(uri);
    ...
    public HttpResponse post(String uri, HttpEntity entity, Map<String, String> headers) throws IOException {
        HttpPost postMethod = new HttpPost(uri);
        postMethod.setEntity(entity);
        configureHeaders(postMethod, headers);
        return executeHttpMethod(postMethod);
    ...
    public HttpResponse get(String uri, Map<String, Object> parameters) throws URISyntaxException, IOException {
        return get(uri, parameters, new HashMap<String, String>());
    }

    public HttpResponse get(String uri, Map<String, Object> parameters, Map<String, String> headers) throws IOException, URISyntaxException {
    ...
    public HttpResponse delete(String uri, Map<String, Object> parameters) throws URISyntaxException, IOException {
        return delete(uri, parameters, new HashMap<String, String>());
    }

    public HttpResponse delete(String uri, Map<String, Object> parameters, Map<String, String> headers) throws IOException, URISyntaxException {
        URI uriObj = new URI(uri);
        List<NameValuePair> optionsInQuery = URLEncodedUtils.parse(uriObj, null);
        List<NameValuePair> queryParams = getNameValuePairsFromMap(parameters);
    ...
    private HttpResponse executeHttpMethod(final HttpRequestBase method) throws IOException {
    ...
    private class OpsgenieHttpClientRetryMechanism {
        ...
        public HttpResponse execute() throws IOException {
            ...
            while (true) {
                request.reset();
                HttpResponse httpResponse = httpClient.execute(request, new ResponseHandler<HttpResponse>() {
                    @Override
                ...
                if(config.getRetryHandler() != null && config.getRetryHandler().retryRequest(request, httpResponse, retryCount)){
                    retryCount++;
                }
                else {
                    return httpResponse;
