...
public class DefaultRequestRetryHandler implements IRequestRetryHandler {
    ...
    public DefaultRequestRetryHandler(int maxRetryCount) {
    ...
    private boolean retry(HttpRequest request, HttpResponse response, IOException exception, int executionCount){
