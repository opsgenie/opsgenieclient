...
public class AlertActionRequest {
    ...
    public AlertActionRequest user(String user) {
        this.user = user;
        return this;
    }
    ...
    public AlertActionRequest note(String note) {
        this.note = note;
        return this;
    }
    ...
    public AlertActionRequest source(String source) {
        this.source = source;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AlertActionRequest alertActionRequest = (AlertActionRequest) o;
        return ObjectUtils.equals(this.user, alertActionRequest.user) &&
                ObjectUtils.equals(this.note, alertActionRequest.note) &&
                ObjectUtils.equals(this.source, alertActionRequest.source);
    }
    ...
    public String toString() {
        ...
        sb.append("class AlertActionRequest {\n");
