...
public class AddSavedSearchRequest {
  ...
  **/
  @NotNull
 @Size(max=100)  @ApiModelProperty(required = true, value = "")
   ...
   * @return description
  **/
 @Size(max=15000)  @ApiModelProperty(value = "")
  ...
  **/
  @NotNull
 @Size(max=1000)  @ApiModelProperty(required = true, value = "")
  ...
  **/
   ...
   * @return teams
  **/
 @Size(max=20)  @ApiModelProperty(value = "Teams that the alert will be routed to send notifications")
