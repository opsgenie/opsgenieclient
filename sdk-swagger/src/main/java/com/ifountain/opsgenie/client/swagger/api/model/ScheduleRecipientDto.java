...
public class ScheduleRecipientDto extends RecipientDto {
    @JsonProperty("name")
    private String name = null;

    public ScheduleRecipientDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ScheduleRecipientDto scheduleRecipientDto = (ScheduleRecipientDto) o;
        return ObjectUtils.equals(this.name, scheduleRecipientDto.name) &&
                super.equals(o);
    }
    ...
    public String toString() {
        ...
        sb.append("class ScheduleRecipientDto {\n");
