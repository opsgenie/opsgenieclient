...
public class GetAlertResponse {
    ...
    @JsonProperty("data")
    private Alert data = null;

    public GetAlertResponse requestId(String requestId) {
    ...
    public GetAlertResponse took(Float took) {
        this.took = took;
        return this;
    }
    ...
    public GetAlertResponse data(Alert data) {
        this.data = data;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return ObjectUtils.equals(this.requestId, getAlertResponse.requestId) &&
                ObjectUtils.equals(this.took, getAlertResponse.took) &&
                ObjectUtils.equals(this.data, getAlertResponse.data);
    }
