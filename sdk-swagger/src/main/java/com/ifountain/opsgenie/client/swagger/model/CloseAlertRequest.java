...
public class CloseAlertRequest {
    ...
    public CloseAlertRequest user(String user) {
        this.user = user;
        return this;
    }
    ...
    public CloseAlertRequest note(String note) {
        this.note = note;
        return this;
    }
    ...
    public CloseAlertRequest source(String source) {
        this.source = source;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CloseAlertRequest closeAlertRequest = (CloseAlertRequest) o;
        return ObjectUtils.equals(this.user, closeAlertRequest.user) &&
                ObjectUtils.equals(this.note, closeAlertRequest.note) &&
                ObjectUtils.equals(this.source, closeAlertRequest.source);
    }
    ...
    public String toString() {
        ...
        sb.append("class CloseAlertRequest {\n");
