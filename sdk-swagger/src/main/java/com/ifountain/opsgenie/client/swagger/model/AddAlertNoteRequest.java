...
public class AddAlertNoteRequest {
    ...
    public AddAlertNoteRequest user(String user) {
        this.user = user;
        return this;
    }
    ...
    public AddAlertNoteRequest note(String note) {
        this.note = note;
        return this;
    }
    ...
    public AddAlertNoteRequest source(String source) {
        this.source = source;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddAlertNoteRequest addAlertNoteRequest = (AddAlertNoteRequest) o;
        return ObjectUtils.equals(this.user, addAlertNoteRequest.user) &&
                ObjectUtils.equals(this.note, addAlertNoteRequest.note) &&
                ObjectUtils.equals(this.source, addAlertNoteRequest.source);
    }
    ...
    public String toString() {
        ...
        sb.append("class AddAlertNoteRequest {\n");
