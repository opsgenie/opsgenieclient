 ...
 * error response will be included in the thrown OpsGenieClientException.</p>
 * <p>When a caller encounters an OpsGenieClientException, it means that the request was successfully sent
